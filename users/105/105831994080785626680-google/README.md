# List of books read by [Chiffi](https://plus.google.com/105831994080785626680)<sup>338</sup>
---
...
### Семейный альбом 4
Акунин Борис
> [2022-12-31] не видал  как ломают пленных в немецком концлагере. Там у них целая методология. Сначала надо расплющить человека, превратить в дрожащую овцу, а потом уже гоняй стадо, как заблагорассудится.
...
> У них там тоже метод, для скорости и отчетности. На первом же допросе вместо «здрасьте» сразу лупят со всей силы. Если видят, что слабак и долго выколачивать признательные не придется, впиваются всерьез. Им же показатели нужны — сколько предателей выявлено.
> Железное правило всякого тоталитарного режима гласит, что за надзирающими тоже нужны надзирающие.
