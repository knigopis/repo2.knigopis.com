# List of books read by [Chiffi](https://plus.google.com/105831994080785626680)<sup>334</sup>
---
...
### Столкновение
Панов Вадим
> [2022-10-09] — Вы не даете им свободы, чтобы продемонстрировать власть.     перестань бросаться громкими словами, от этого они тускнеют,  — Мы – жемчужины, которые оттеняют бриллиант. Мы можем затмить его только в том случае, если бриллиант перестанет быть бриллиантом.
